...
#' @format A dataframe with 98436 rows and 5 variables: \describe{
...
#'   species sampled} \item{LENGTH}{Length class} \item{WEIGHT}{Corresponding
#'   weight of sampled fish} }
#'
#' @source This is example data was modified from Fisheries and Oceans
